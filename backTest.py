    ...
    def start(self):
        ...
        for i in range(0,len(self.rawData)):
            ...
            if abs(fundingRate)>0.2 and counts < 5:
                if counts == 0:
                    print('-----------------------------------------')
                print(self.rawData.loc[i-2+480, 'timestamp'],self.rawData.loc[i-2+480, 'vwap'],fundingRate)
                counts +=1
            '''
            ...
            if fundingRate!=lastFR :
                ...
                amount = (self.principal+self.revenue)*1.5
                #amount = self.principal
                if fundingRate<0 and self.position<=0:
                    vwap *= (1-priceShift)
                    if self.position<0:
                        self.revenueThisTime = self.position*(vwap-self.positionPrice)/vwap
                    ...
                    print(timestamp,  "\tRevenue",round(self.revenueThisTime,2),"(",round((vwap-self.positionPrice)/vwap*-100,2),"%)\tTotal Revenue:",round(self.revenue,2),"FR",round(fundingRate,4),"Position:",round(self.position,2),"\tBuy ",round(amountThisTime,2),"\tUSD @", round(vwap,2))
                    print("RevenuePrice:",round(self.revenuePrice,2),"RevenueFee:",round(self.revenueFee,2),"revenueFunding:",round(self.revenueFunding,2),"TurnOver:",round(self.turnOver,2))
                    ...
                    print(timestamp, "\tRevenue",round(self.revenueThisTime,2),"(",round((vwap-self.positionPrice)/vwap*100,2),"%)\tTotal Revenue:",round(self.revenue,2),"FR",round(fundingRate,4),"Position:",round(self.position,2),"\tSell", round(amountThisTime,2), "\tUSD @", round(vwap,2))
                    print("RevenuePrice:",round(self.revenuePrice,2),"RevenueFee:",round(self.revenueFee,2),"revenueFunding:",round(self.revenueFunding,2),"TurnOver:",round(self.turnOver,2))
                    self.positionPrice = vwap
                lastFR = fundingRate
        ...
        if self.position < 0:
            vwap *= (1 - priceShift)
            revenueThisTime = self.position * (vwap - self.positionPrice)/vwap
            self.revenue += revenueThisTime
            self.revenuePrice += revenueThisTime
            self.revenueHistory.append(self.revenue)
            print(timestamp,  "\tRevenue",round(revenueThisTime,2),"(",round((vwap-self.positionPrice)/vwap*-100,2),"%)\tTotal Revenue:",round(self.revenue,2),"FR",round(fundingRate,4),"Position:",round(self.position,2),"\tBuy ",round(amountThisTime,2),"\tUSD @", round(vwap,2))
            print("RevenuePrice:",round(self.revenuePrice,2),"RevenueFee:",round(self.revenueFee,2),"revenueFunding:",round(self.revenueFunding,2),"TurnOver:",round(self.turnOver,2))
            ...
            self.revenuePrice += revenueThisTime
            self.revenueHistory.append(self.revenue)
            print(timestamp, "\tRevenue",round(revenueThisTime,2),"(",round((vwap-self.positionPrice)/vwap*100,2),"%)\tTotal Revenue:",round(self.revenue,2),"FR",round(fundingRate,4),"Position:",round(self.position,2),"\tSell", round(amountThisTime,2), "\tUSD @", round(vwap,2))
            print("RevenuePrice:",round(self.revenuePrice,2),"RevenueFee:",round(self.revenueFee,2),"revenueFunding:",round(self.revenueFunding,2),"TurnOver:",round(self.turnOver,2))
